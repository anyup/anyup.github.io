...
module.exports = {
  title: "uni-app工程化组件库",
  description: "基于VuePress的uni-app框架文档库",
  base, // '/<仓库名>/'， 默认'/'
  head: [
  ...
  themeConfig: {
    ...
    author: {
      ...
      name: "anyup", // 必需
      href: "https://github.com/anyup", // 可选的
    },
    social: {
      // 社交图标，显示于博主信息栏和页脚栏
      ...
      icons: [
        {
          ...
          title: "发邮件",
          link: "mailto:anyupxing@163.com",
        },
        {
          iconClass: "icon-github",
          title: "GitHub",
          link: "https://github.com/anyup",
        },
      ],
    },
    footer: {
      ...
      copyrightInfo: "anyup | MIT License", // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  plugins: [
